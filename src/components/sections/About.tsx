      ...
      <div className="grid md:grid-cols-2 gap-12 items-center">
        <div className="space-y-6 text-left">
          <p className="text-lg text-gray-600 dark:text-gray-300 leading-relaxed">
            I'm a passionate front-end web developer (also a full-stack and UI/UX
            enthusiast) with almost 5 years of experience creating digital
          ...
          <p className="text-lg text-gray-600 dark:text-gray-300 leading-relaxed">
            ...
            creating personal projects, or sharing my knowledge through writing
            and mentoring.
          </p>
